...
window.onload = function()
{
	...
	// ENHANCEMENT: added Asset Manager, PagePicker links. -JSB 2008-11-17
	GetE('divDP_AssetManager').style.display = '' ;
	GetE('divDP_PagePicker').style.display = '' ;
...
// ENHANCEMENT: allows users to choose an anchor from our page template that doesn't appear in the FCK body. -JSB 2007-11-30
// FCKTools.AddSelectOption( GetE('cmbAnchorName'), "PageTop", "PageTop" ) ;
// FCKTools.AddSelectOption( GetE('cmbAnchorName'), "ContentTop", "ContentTop" ) ;
...
// ENHANCEMENT: add Asset Manager, Page Picker support. -JSB 2008-11-17
function DP_openAssetManager()
{
	OpenFileBrowser( FCKConfig.DP_AssetManagerURL, 960, 500 ) ;
}

function DP_openPagePicker()
{
	OpenFileBrowser( FCKConfig.DP_PagePickerURL, 960, 500 ) ;
}
